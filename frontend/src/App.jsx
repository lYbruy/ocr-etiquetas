  ...
  async function tirarFoto() {
    ...
    canvas.toBlob(async (blob) => {
      try {
        ...
        const res = await fetch('ocr-etiquetas-production.up.railway.upload', { method: 'POST', body: form })
        ...
        {resultado && !loading && (
          <div className="resultado">
            ...
            <div className="actions">
              <a href="ocr-etiquetas-production.up.railway.excel" target="_blank" rel="noreferrer" className="btn-download">
              ...
              <a href="ocr-etiquetas-production.up.railway.csv" target="_blank" rel="noreferrer" className="btn-download">
